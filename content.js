var quoteNum = Math.floor(Math.random() * (8 - 1)) + 1;
var quoteArr = ["dummy","ถ้าคิดไรไม่ออก<br>คิดถึงเราได้ตลอดเลยนะ","เด็กบางมดไม่เจ้าชู้<br>ใครๆก็รู้กัน","เซื่อในสิ่งที่เฮ็ด<br>เฮ็ดในสิ่งที่เซื่อ" ,"ถ้าใส่ใจแล้วไม่มีค่า<br>ใส่หน้าแม่งเลย","อ่อนโยนแต่ไม่อ่อนแอ<br>แข็งแกร่งไม่แข็งกระด้าง","บางครั้งอาจท้อ<br>แต่ก็ไม่คิดที่จะไปต่อ","แรกๆก็ตั้งใจรัก ได้สักพัก<br>ก็ตั้งใจลืมกัน"];
